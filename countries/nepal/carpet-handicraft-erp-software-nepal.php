...
$pageTitle = "Carpet & Handicraft ERP Software in Nepal | Tibetan Rugs & Artisan ERP";
$pageDescription = "Specialized ERP for Nepal handmade Tibetan carpets, pashmina, felt products, thangka paintings and artisan handicrafts. Manage wool inventory, weaver records, and export shipments.";
$pageKeywords = "Carpet ERP Nepal, Handicraft software Nepal, Tibetan rug ERP Kathmandu, Wool inventory Nepal, Pashmina ERP Nepal, Artisan management Nepal, Handicraft export software Nepal";
$pageCanonical = "https://www.digifysoft.in/carpet-handicraft-erp-software-nepal";
...
<div class="npv-wrapper">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-7 mb-4 mb-lg-0">
                    ...
                    <br>
                    <div class="npv-badge">
                        <span>🧶 Preserving Himalayan Craftsmanship with Digital Precision</span>
                    </div>
                    <h1 class="np-trans" data-en="Handmade Carpet &amp; Handicraft ERP Software in Nepal" data-np="नेपालमा गलैँचा तथा हस्तकला (Carpet &amp; Handicraft) ERP सफ्टवेयर">
                        Handmade Carpet &amp; Handicraft ERP Software in Nepal
                    </h1>
                    <p class="npv-hero-desc np-trans" data-en="Manage Tibetan wool and silk inventory, custom carpet design knotting, artisan piece-rate wage records, washing/finishing stages, and international export consignments." data-np="नेपाली गलैँचा (कार्पेट), पश्मिना र हस्तकला उद्योगहरूका लागि धागो, कालिगढ ज्याला, फिनिसिङ र निर्यात व्यवस्थापन सफ्टवेयर।">
                        Manage Tibetan wool and silk inventory, custom carpet design knotting, artisan piece-rate wage records, washing/finishing stages, and international export consignments.
                    </p>
                ...
                <div class="col-lg-5">
                    <div class="npv-lead-card">
                        ...
                        <p class="np-trans" data-en="Tailored for Handmade Carpet &amp; Handicraft ERP Software in Nepal across Nepal." data-np="नेपालभरका व्यवसायहरूका लागि अनुकूलित ERP प्रणाली।">Tailored for Handmade Carpet &amp; Handicraft ERP Software in Nepal across Nepal.</p>
                        
                        <form action="send_mail.php" method="POST" id="nepalVerticalLeadForm">
                            <input type="hidden" name="source" value="Nepal Handmade Carpet &amp; Handicraft ERP Software in Nepal Page">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 mb-4">
                    <div class="npv-highlight-card">
                        <div class="npv-hl-icon"><i class="fa-solid fa-palette"></i></div>
                        <div>
                            <h4 class="npv-hl-title np-trans" data-en="Custom Design, Knot Density &amp; Size Cataloging">Custom Design, Knot Density &amp; Size Cataloging</h4>
                            <p class="npv-hl-desc np-trans" data-en="Track carpets by knots-per-inch (60/100/150 knot), custom color palettes, wool/silk blends, and custom dimensions.">Track carpets by knots-per-inch (60/100/150 knot), custom color palettes, wool/silk blends, and custom dimensions.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mb-4">
                    <div class="npv-highlight-card">
                        <div class="npv-hl-icon"><i class="fa-solid fa-users"></i></div>
                        <div>
                            <h4 class="npv-hl-title np-trans" data-en="Weaver &amp; Artisan Piece-Rate Settlements">Weaver &amp; Artisan Piece-Rate Settlements</h4>
                            <p class="npv-hl-desc np-trans" data-en="Calculate fair piece-rate wages based on square-meter woven area, knot difficulty, and production advances.">Calculate fair piece-rate wages based on square-meter woven area, knot difficulty, and production advances.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mb-4">
                    <div class="npv-highlight-card">
                        ...
                        <div>
                            <h4 class="npv-hl-title np-trans" data-en="Tibetan &amp; New Zealand Wool Raw Stock">Tibetan &amp; New Zealand Wool Raw Stock</h4>
                            <p class="npv-hl-desc np-trans" data-en="Monitor raw wool carding, spinning, vegetable dyeing batches, and pashmina yarn inventory.">Monitor raw wool carding, spinning, vegetable dyeing batches, and pashmina yarn inventory.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mb-4">
                    <div class="npv-highlight-card">
                        <div class="npv-hl-icon"><i class="fa-solid fa-plane-departure"></i></div>
                        <div>
                            <h4 class="npv-hl-title np-trans" data-en="Export Documentation (Air &amp; Sea Cargo)">Export Documentation (Air &amp; Sea Cargo)</h4>
                            <p class="npv-hl-desc np-trans" data-en="Generate export invoices, Certificates of Origin, GSP forms, and freight packaging lists for US/Europe buyers.">Generate export invoices, Certificates of Origin, GSP forms, and freight packaging lists for US/Europe buyers.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="py-5 bg-white">
        <div class="container">
            <div class="row align-items-center mb-5">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    ...
                    <ul class="list-unstyled mt-4" style="line-height: 2.2; font-size: 16px;">
                        <li class="np-trans" data-en="Hand-Knotted Tibetan Carpet Manufacturers"><i class="fa-solid fa-circle-check text-danger me-2"></i> Hand-Knotted Tibetan Carpet Manufacturers</li><li class="np-trans" data-en="Pashmina &amp; Cashmere Shawl Producers"><i class="fa-solid fa-circle-check text-danger me-2"></i> Pashmina &amp; Cashmere Shawl Producers</li><li class="np-trans" data-en="Wool Felt &amp; Handicraft Exporters"><i class="fa-solid fa-circle-check text-danger me-2"></i> Wool Felt &amp; Handicraft Exporters</li><li class="np-trans" data-en="Handmade Paper &amp; Stationery Manufacturers"><i class="fa-solid fa-circle-check text-danger me-2"></i> Handmade Paper &amp; Stationery Manufacturers</li><li class="np-trans" data-en="Metal Statues, Singing Bowls &amp; Thangka Studios"><i class="fa-solid fa-circle-check text-danger me-2"></i> Metal Statues, Singing Bowls &amp; Thangka Studios</li><li class="np-trans" data-en="Fair-Trade Artisan Cooperatives"><i class="fa-solid fa-circle-check text-danger me-2"></i> Fair-Trade Artisan Cooperatives</li>
                    </ul>
                </div>
                <div class="col-lg-6">
            ...
            <div class="pt-4 border-top">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Custom Rug Spec Cataloging">Custom Rug Spec Cataloging</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Wool &amp; Silk Blend Inventory">Wool &amp; Silk Blend Inventory</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Weaver Piece-Rate Wage Records">Weaver Piece-Rate Wage Records</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Washing &amp; Finishing Stage Tracking">Washing &amp; Finishing Stage Tracking</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Artisan Advances &amp; Settlements">Artisan Advances &amp; Settlements</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="International Export Invoicing">International Export Invoicing</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Consignment Cargo Packing">Consignment Cargo Packing</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Order Profitability Analytics">Order Profitability Analytics</span></div></div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-5" style="background: linear-gradient(135deg, #dc2626 0%, #991b1b 100%); color: #fff;">
        <div class="container text-center">
            ...
            <p class="mx-auto mb-4 text-white-50" style="max-width: 680px; font-size: 17px;">Experience a personalized 15-minute system walkthrough calibrated for Handmade Carpet &amp; Handicraft ERP Software in Nepal.</p>
