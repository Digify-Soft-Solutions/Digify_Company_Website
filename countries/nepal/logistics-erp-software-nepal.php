...
$pageTitle = "Logistics & Transportation ERP Software in Nepal | Fleet & Cargo Management";
$pageDescription = "Logistics, transport and freight ERP software in Nepal. Manage truck dispatches, trip consignment notes (Bilty), fleet maintenance, driver trip advances and cargo billing.";
$pageKeywords = "Logistics ERP Nepal, Transport software Nepal, Cargo management Kathmandu, Fleet management Birgunj, Truck consignment ERP Nepal, Freight forwarding software Nepal";
$pageCanonical = "https://www.digifysoft.in/logistics-erp-software-nepal";
...
<div class="npv-wrapper">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-7 mb-4 mb-lg-0">
                    ...
                    <br>
                    <div class="npv-badge">
                        <span>🚛 Cross-Border & Domestic Cargo Suite</span>
                    </div>
                    <h1 class="np-trans" data-en="Logistics, Cargo &amp; Transportation ERP Software in Nepal" data-np="नेपालमा यातायात तथा लजिस्टिक (Logistics &amp; Transport) ERP सफ्टवेयर">
                        Logistics, Cargo &amp; Transportation ERP Software in Nepal
                    </h1>
                    <p class="npv-hero-desc np-trans" data-en="Manage domestic transportation, Birgunj/Kolkata border cargo movements, consignment notes (Bilty), driver trip expenses, fleet fuel logs, and transport customer invoicing." data-np="यातायात व्यवसायी, कार्गो र ढुवानी कम्पनीहरूका लागि बिल्टी (Bilty), ट्रिप खर्च, डिजेल हिसाब र गाडी मर्मत व्यवस्थापन।">
                        Manage domestic transportation, Birgunj/Kolkata border cargo movements, consignment notes (Bilty), driver trip expenses, fleet fuel logs, and transport customer invoicing.
                    </p>
                ...
                <div class="col-lg-5">
                    <div class="npv-lead-card">
                        ...
                        <p class="np-trans" data-en="Tailored for Logistics, Cargo &amp; Transportation ERP Software in Nepal across Nepal." data-np="नेपालभरका व्यवसायहरूका लागि अनुकूलित ERP प्रणाली।">Tailored for Logistics, Cargo &amp; Transportation ERP Software in Nepal across Nepal.</p>
                        
                        <form action="send_mail.php" method="POST" id="nepalVerticalLeadForm">
                            <input type="hidden" name="source" value="Nepal Logistics, Cargo &amp; Transportation ERP Software in Nepal Page">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 mb-4">
                    <div class="npv-highlight-card">
                        <div class="npv-hl-icon"><i class="fa-solid fa-file-lines"></i></div>
                        <div>
                            <h4 class="npv-hl-title np-trans" data-en="Consignment Note (Bilty) Generation">Consignment Note (Bilty) Generation</h4>
                            <p class="npv-hl-desc np-trans" data-en="Instant creation of official multi-copy consignment notes with sender/receiver details, packages, and freight.">Instant creation of official multi-copy consignment notes with sender/receiver details, packages, and freight.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mb-4">
                    <div class="npv-highlight-card">
                        <div class="npv-hl-icon"><i class="fa-solid fa-gas-pump"></i></div>
                        <div>
                            <h4 class="npv-hl-title np-trans" data-en="Trip Fuel, Toll &amp; Driver Advances">Trip Fuel, Toll &amp; Driver Advances</h4>
                            <p class="npv-hl-desc np-trans" data-en="Issue trip cash advances, log fuel pump coupons, highway tolls, and calculate trip net profitability.">Issue trip cash advances, log fuel pump coupons, highway tolls, and calculate trip net profitability.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mb-4">
                    <div class="npv-highlight-card">
                        <div class="npv-hl-icon"><i class="fa-solid fa-wrench"></i></div>
                        <div>
                            <h4 class="npv-hl-title np-trans" data-en="Truck &amp; Trailer Maintenance Records">Truck &amp; Trailer Maintenance Records</h4>
                            <p class="npv-hl-desc np-trans" data-en="Track tire replacement mileage, engine servicing logs, road tax renewals, and insurance expirations.">Track tire replacement mileage, engine servicing logs, road tax renewals, and insurance expirations.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mb-4">
                    <div class="npv-highlight-card">
                        <div class="npv-hl-icon"><i class="fa-solid fa-money-check-dollar"></i></div>
                        <div>
                            <h4 class="npv-hl-title np-trans" data-en="Customer Freight Ledger &amp; Transporter Accounts">Customer Freight Ledger &amp; Transporter Accounts</h4>
                            <p class="npv-hl-desc np-trans" data-en="Manage corporate freight billing, third-party hired truck commissions, and pending freight collections.">Manage corporate freight billing, third-party hired truck commissions, and pending freight collections.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="py-5 bg-white">
        <div class="container">
            <div class="row align-items-center mb-5">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    ...
                    <ul class="list-unstyled mt-4" style="line-height: 2.2; font-size: 16px;">
                        <li class="np-trans" data-en="Domestic Trucking &amp; Fleet Operators"><i class="fa-solid fa-circle-check text-danger me-2"></i> Domestic Trucking &amp; Fleet Operators</li><li class="np-trans" data-en="Cross-Border Freight Forwarders (Nepal-India)"><i class="fa-solid fa-circle-check text-danger me-2"></i> Cross-Border Freight Forwarders (Nepal-India)</li><li class="np-trans" data-en="Courier &amp; Express Parcel Companies"><i class="fa-solid fa-circle-check text-danger me-2"></i> Courier &amp; Express Parcel Companies</li><li class="np-trans" data-en="Warehouse &amp; Container Depot Operators"><i class="fa-solid fa-circle-check text-danger me-2"></i> Warehouse &amp; Container Depot Operators</li><li class="np-trans" data-en="Heavy Machinery Transport Specialists"><i class="fa-solid fa-circle-check text-danger me-2"></i> Heavy Machinery Transport Specialists</li><li class="np-trans" data-en="Cold-Chain Transport Services"><i class="fa-solid fa-circle-check text-danger me-2"></i> Cold-Chain Transport Services</li>
                    </ul>
                </div>
                <div class="col-lg-6">
            ...
            <div class="pt-4 border-top">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Bilty / Consignment Management">Bilty / Consignment Management</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Trip Expense &amp; Fuel Logs">Trip Expense &amp; Fuel Logs</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Driver Advance Settlements">Driver Advance Settlements</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Fleet Maintenance Records">Fleet Maintenance Records</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Third-Party Truck Commissions">Third-Party Truck Commissions</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Customer Freight Invoicing">Customer Freight Invoicing</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Route Profitability Analytics">Route Profitability Analytics</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Warehouse Cargo Staging">Warehouse Cargo Staging</span></div></div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-5" style="background: linear-gradient(135deg, #dc2626 0%, #991b1b 100%); color: #fff;">
        <div class="container text-center">
            ...
            <p class="mx-auto mb-4 text-white-50" style="max-width: 680px; font-size: 17px;">Experience a personalized 15-minute system walkthrough calibrated for Logistics, Cargo &amp; Transportation ERP Software in Nepal.</p>
