...
$pageTitle = "Manufacturing ERP Software in Nepal | Factory Production & BOM ERP";
$pageDescription = "Production and manufacturing ERP software in Nepal for plastic, metal, furniture, electronics, chemicals, packaging and industrial factories. Full BOM and work order tracking.";
$pageKeywords = "Manufacturing ERP Nepal, Factory software Nepal, Production ERP Kathmandu, Industrial software Biratnagar, BOM software Nepal, Machine work order ERP Nepal";
$pageCanonical = "https://www.digifysoft.in/manufacturing-erp-software-nepal";
...
<div class="npv-wrapper">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-7 mb-4 mb-lg-0">
                    ...
                    <br>
                    <div class="npv-badge">
                        <span>🏭 Industrial Strength Manufacturing ERP</span>
                    </div>
                    <h1 class="np-trans" data-en="Manufacturing &amp; Factory Production ERP Software in Nepal" data-np="नेपालमा उत्पादन तथा उद्योग (Manufacturing) ERP सफ्टवेयर">
                        Manufacturing &amp; Factory Production ERP Software in Nepal
                    </h1>
                    <p class="npv-hero-desc np-trans" data-en="Manage raw materials, machine work centers, multi-level Bill of Materials (BOM), production work orders, scrap rates, finished goods inventory, and sales distribution across Nepal." data-np="फ्याक्ट्री, उद्योग र कलकारखानाका लागि कच्चा पदार्थ, उत्पादन कार्य (BOM), मेसिन संचालन र लागत व्यवस्थापन सफ्टवेयर।">
                        Manage raw materials, machine work centers, multi-level Bill of Materials (BOM), production work orders, scrap rates, finished goods inventory, and sales distribution across Nepal.
                    </p>
                ...
                <div class="col-lg-5">
                    <div class="npv-lead-card">
                        ...
                        <p class="np-trans" data-en="Tailored for Manufacturing &amp; Factory Production ERP Software in Nepal across Nepal." data-np="नेपालभरका व्यवसायहरूका लागि अनुकूलित ERP प्रणाली।">Tailored for Manufacturing &amp; Factory Production ERP Software in Nepal across Nepal.</p>
                        
                        <form action="send_mail.php" method="POST" id="nepalVerticalLeadForm">
                            <input type="hidden" name="source" value="Nepal Manufacturing &amp; Factory Production ERP Software in Nepal Page">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 mb-4">
                    <div class="npv-highlight-card">
                        <div class="npv-hl-icon"><i class="fa-solid fa-layer-group"></i></div>
                        <div>
                            <h4 class="npv-hl-title np-trans" data-en="Multi-Tier Bill of Materials (BOM)">Multi-Tier Bill of Materials (BOM)</h4>
                            <p class="npv-hl-desc np-trans" data-en="Define complex raw material, sub-assembly, hardware, and packaging requirements per production unit.">Define complex raw material, sub-assembly, hardware, and packaging requirements per production unit.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mb-4">
                    <div class="npv-highlight-card">
                        <div class="npv-hl-icon"><i class="fa-solid fa-clipboard-check"></i></div>
                        <div>
                            <h4 class="npv-hl-title np-trans" data-en="Work Orders &amp; Shop-Floor Tracking">Work Orders &amp; Shop-Floor Tracking</h4>
                            <p class="npv-hl-desc np-trans" data-en="Issue work orders to shop-floor stations, track production progress, and monitor machine output.">Issue work orders to shop-floor stations, track production progress, and monitor machine output.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mb-4">
                    <div class="npv-highlight-card">
                        <div class="npv-hl-icon"><i class="fa-solid fa-recycle"></i></div>
                        <div>
                            <h4 class="npv-hl-title np-trans" data-en="Scrap, Wastage &amp; Yield Analysis">Scrap, Wastage &amp; Yield Analysis</h4>
                            <p class="npv-hl-desc np-trans" data-en="Capture raw material scrap percentages and factor recycling/wastage into finished unit costing.">Capture raw material scrap percentages and factor recycling/wastage into finished unit costing.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mb-4">
                    <div class="npv-highlight-card">
                        ...
                        <div>
                            <h4 class="npv-hl-title np-trans" data-en="Comprehensive Landed Production Costing">Comprehensive Landed Production Costing</h4>
                            <p class="npv-hl-desc np-trans" data-en="Combine raw material costs, direct machine power, labor wages, and factory overheads into exact landed cost.">Combine raw material costs, direct machine power, labor wages, and factory overheads into exact landed cost.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="py-5 bg-white">
        <div class="container">
            <div class="row align-items-center mb-5">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    ...
                    <ul class="list-unstyled mt-4" style="line-height: 2.2; font-size: 16px;">
                        <li class="np-trans" data-en="Plastic &amp; Polymer Molding Plants"><i class="fa-solid fa-circle-check text-danger me-2"></i> Plastic &amp; Polymer Molding Plants</li><li class="np-trans" data-en="Metal Fabrication &amp; Hardware Works"><i class="fa-solid fa-circle-check text-danger me-2"></i> Metal Fabrication &amp; Hardware Works</li><li class="np-trans" data-en="Furniture &amp; Wooden Product Factories"><i class="fa-solid fa-circle-check text-danger me-2"></i> Furniture &amp; Wooden Product Factories</li><li class="np-trans" data-en="Electrical &amp; Appliance Assembly Units"><i class="fa-solid fa-circle-check text-danger me-2"></i> Electrical &amp; Appliance Assembly Units</li><li class="np-trans" data-en="Packaging, Carton &amp; Paper Mills"><i class="fa-solid fa-circle-check text-danger me-2"></i> Packaging, Carton &amp; Paper Mills</li><li class="np-trans" data-en="Chemical &amp; Industrial Products"><i class="fa-solid fa-circle-check text-danger me-2"></i> Chemical &amp; Industrial Products</li>
                    </ul>
                </div>
                <div class="col-lg-6">
            ...
            <div class="pt-4 border-top">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Multi-Level BOM Engineering">Multi-Level BOM Engineering</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Work Order Dispatch">Work Order Dispatch</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Raw Material Consumption">Raw Material Consumption</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Machine Work Center Tracking">Machine Work Center Tracking</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Scrap &amp; Rework Logging">Scrap &amp; Rework Logging</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Finished Goods Staging">Finished Goods Staging</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Factory Overhead Allocation">Factory Overhead Allocation</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Production Cost Analytics">Production Cost Analytics</span></div></div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-5" style="background: linear-gradient(135deg, #dc2626 0%, #991b1b 100%); color: #fff;">
        <div class="container text-center">
            ...
            <p class="mx-auto mb-4 text-white-50" style="max-width: 680px; font-size: 17px;">Experience a personalized 15-minute system walkthrough calibrated for Manufacturing &amp; Factory Production ERP Software in Nepal.</p>
