...
$pageTitle = "Tea Business ERP Software in Nepal | Estate, Processing & Export ERP";
$pageDescription = "Dedicated Tea Business ERP software in Nepal for tea estates, Orthodox & CTC tea processors, tea traders, wholesalers and exporters across Ilam, Jhapa and Panchthar.";
$pageKeywords = "Tea ERP Nepal, Tea estate software Nepal, Orthodox tea software Ilam, CTC tea ERP Jhapa, Tea export software Nepal, Tea processing ERP Nepal, Tea tasting auction software";
$pageCanonical = "https://www.digifysoft.in/tea-erp-software-nepal";
...
<div class="npv-wrapper">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-7 mb-4 mb-lg-0">
                    ...
                    <br>
                    <div class="npv-badge">
                        <span>🍵 Built for Nepal Tea Producers & Exporters</span>
                    </div>
                    <h1 class="np-trans" data-en="Tea Business &amp; Estate Processing ERP Software in Nepal" data-np="नेपालमा चिया उद्योग तथा प्रशोधन (Tea Business) ERP सफ्टवेयर">
                        Tea Business &amp; Estate Processing ERP Software in Nepal
                    </h1>
                    <p class="npv-hero-desc np-trans" data-en="Manage green leaf procurement from smallholders, factory processing batches, tea grading, blending inventory, export packaging, and wholesale auctions across Ilam, Jhapa, and overseas markets." data-np="इलाम र झापाका चिया बगान, अर्थोडक्स तथा सिटिसी (CTC) चिया प्रशोधन कारखाना र चिया निर्यातकर्ताहरूका लागि विशेष सफ्टवेयर।">
                        Manage green leaf procurement from smallholders, factory processing batches, tea grading, blending inventory, export packaging, and wholesale auctions across Ilam, Jhapa, and overseas markets.
                    </p>
                ...
                <div class="col-lg-5">
                    <div class="npv-lead-card">
                        ...
                        <p class="np-trans" data-en="Tailored for Tea Business &amp; Estate Processing ERP Software in Nepal across Nepal." data-np="नेपालभरका व्यवसायहरूका लागि अनुकूलित ERP प्रणाली।">Tailored for Tea Business &amp; Estate Processing ERP Software in Nepal across Nepal.</p>
                        
                        <form action="send_mail.php" method="POST" id="nepalVerticalLeadForm">
                            <input type="hidden" name="source" value="Nepal Tea Business &amp; Estate Processing ERP Software in Nepal Page">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 mb-4">
                    <div class="npv-highlight-card">
                        <div class="npv-hl-icon"><i class="fa-solid fa-leaf"></i></div>
                        <div>
                            <h4 class="npv-hl-title np-trans" data-en="Green Leaf Collection &amp; Farmer Payables">Green Leaf Collection &amp; Farmer Payables</h4>
                            <p class="npv-hl-desc np-trans" data-en="Record daily green leaf pluck weights, quality grading, moisture deductions, and bi-weekly farmer payments.">Record daily green leaf pluck weights, quality grading, moisture deductions, and bi-weekly farmer payments.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mb-4">
                    <div class="npv-highlight-card">
                        <div class="npv-hl-icon"><i class="fa-solid fa-industry"></i></div>
                        <div>
                            <h4 class="npv-hl-title np-trans" data-en="Tea Processing, Withering &amp; CTC/Orthodox Batches">Tea Processing, Withering &amp; CTC/Orthodox Batches</h4>
                            <p class="npv-hl-desc np-trans" data-en="Track drying weight loss, oxidation stages, sorting grades (FTGFOP, BOP, Dust), and packaging yield.">Track drying weight loss, oxidation stages, sorting grades (FTGFOP, BOP, Dust), and packaging yield.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mb-4">
                    <div class="npv-highlight-card">
                        ...
                        <div>
                            <h4 class="npv-hl-title np-trans" data-en="Tea Bag, Tin &amp; Bulk Sack Inventory">Tea Bag, Tin &amp; Bulk Sack Inventory</h4>
                            <p class="npv-hl-desc np-trans" data-en="Manage raw packaging material, master cartons, loose tea warehouses, and branded retail tea stock.">Manage raw packaging material, master cartons, loose tea warehouses, and branded retail tea stock.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mb-4">
                    <div class="npv-highlight-card">
                        <div class="npv-hl-icon"><i class="fa-solid fa-ship"></i></div>
                        <div>
                            <h4 class="npv-hl-title np-trans" data-en="Export Documentation &amp; Multi-Currency Sales">Export Documentation &amp; Multi-Currency Sales</h4>
                            <p class="npv-hl-desc np-trans" data-en="Generate export invoices in USD/EUR, customs certificates of origin, Phytosanitary logs, and container manifests.">Generate export invoices in USD/EUR, customs certificates of origin, Phytosanitary logs, and container manifests.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="py-5 bg-white">
        <div class="container">
            <div class="row align-items-center mb-5">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    ...
                    <ul class="list-unstyled mt-4" style="line-height: 2.2; font-size: 16px;">
                        <li class="np-trans" data-en="Orthodox Tea Estates (Ilam &amp; Hills)"><i class="fa-solid fa-circle-check text-danger me-2"></i> Orthodox Tea Estates (Ilam &amp; Hills)</li><li class="np-trans" data-en="CTC Tea Processing Factories (Jhapa &amp; Terai)"><i class="fa-solid fa-circle-check text-danger me-2"></i> CTC Tea Processing Factories (Jhapa &amp; Terai)</li><li class="np-trans" data-en="Specialty &amp; Organic Tea Exporters"><i class="fa-solid fa-circle-check text-danger me-2"></i> Specialty &amp; Organic Tea Exporters</li><li class="np-trans" data-en="Tea Blenders &amp; Packaging Brands"><i class="fa-solid fa-circle-check text-danger me-2"></i> Tea Blenders &amp; Packaging Brands</li><li class="np-trans" data-en="Wholesale Tea Traders &amp; Auctioneers"><i class="fa-solid fa-circle-check text-danger me-2"></i> Wholesale Tea Traders &amp; Auctioneers</li><li class="np-trans" data-en="Boutique Tea Retailers &amp; Cafes"><i class="fa-solid fa-circle-check text-danger me-2"></i> Boutique Tea Retailers &amp; Cafes</li>
                    </ul>
                </div>
                <div class="col-lg-6">
            ...
            <div class="pt-4 border-top">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Green Leaf Inward Weighing">Green Leaf Inward Weighing</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Processing Yield &amp; Loss Tracking">Processing Yield &amp; Loss Tracking</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Grade &amp; Batch Classification">Grade &amp; Batch Classification</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Blend Recipe Management">Blend Recipe Management</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Export Proforma &amp; Invoicing">Export Proforma &amp; Invoicing</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Smallholder Farmer Accounts">Smallholder Farmer Accounts</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Packaging Material Inventory">Packaging Material Inventory</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Estate Profitability Reports">Estate Profitability Reports</span></div></div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-5" style="background: linear-gradient(135deg, #dc2626 0%, #991b1b 100%); color: #fff;">
        <div class="container text-center">
            ...
            <p class="mx-auto mb-4 text-white-50" style="max-width: 680px; font-size: 17px;">Experience a personalized 15-minute system walkthrough calibrated for Tea Business &amp; Estate Processing ERP Software in Nepal.</p>
