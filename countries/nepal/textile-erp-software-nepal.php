...
$pageTitle = "Textile ERP Software in Nepal | Fabric Mills & Yarn Inventory ERP";
$pageDescription = "Textile mill and fabric trading ERP software in Nepal. Manage raw yarn, weaving looms, dyeing chemicals, wholesale fabric meters, and dealer credit accounts.";
$pageKeywords = "Textile ERP Nepal, Fabric mill software Nepal, Yarn inventory Kathmandu, Weaving mill ERP Nepal, Textile wholesale software Biratnagar, Dyeing chemical inventory Nepal";
$pageCanonical = "https://www.digifysoft.in/textile-erp-software-nepal";
...
<div class="npv-wrapper">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-7 mb-4 mb-lg-0">
                    ...
                    <br>
                    <div class="npv-badge">
                        <span>🧶 Textile Mills & Fabric Trading Suite</span>
                    </div>
                    <h1 class="np-trans" data-en="Textile Mills &amp; Fabric Trading ERP Software in Nepal" data-np="नेपालमा टेक्सटाइल तथा कपडा मिल (Textile) ERP सफ्टवेयर">
                        Textile Mills &amp; Fabric Trading ERP Software in Nepal
                    </h1>
                    <p class="npv-hero-desc np-trans" data-en="Control raw yarn inventory, loom production runs, dyeing batch formulations, fabric meter roll inventories, and wholesale distributor billing across Nepal." data-np="धागो, कपडा बुनाई मिल (Weaving), रङ्ग्याउने कारखाना र कपडाका थोक व्यापारीहरूका लागि पूर्ण इन्भेन्टरी र बिलिङ प्रणाली।">
                        Control raw yarn inventory, loom production runs, dyeing batch formulations, fabric meter roll inventories, and wholesale distributor billing across Nepal.
                    </p>
                ...
                <div class="col-lg-5">
                    <div class="npv-lead-card">
                        ...
                        <p class="np-trans" data-en="Tailored for Textile Mills &amp; Fabric Trading ERP Software in Nepal across Nepal." data-np="नेपालभरका व्यवसायहरूका लागि अनुकूलित ERP प्रणाली।">Tailored for Textile Mills &amp; Fabric Trading ERP Software in Nepal across Nepal.</p>
                        
                        <form action="send_mail.php" method="POST" id="nepalVerticalLeadForm">
                            <input type="hidden" name="source" value="Nepal Textile Mills &amp; Fabric Trading ERP Software in Nepal Page">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 mb-4">
                    <div class="npv-highlight-card">
                        ...
                        <div>
                            <h4 class="npv-hl-title np-trans" data-en="Yarn Lot &amp; Cone Inventory">Yarn Lot &amp; Cone Inventory</h4>
                            <p class="npv-hl-desc np-trans" data-en="Track yarn counts (Denier/Ne), raw cotton fiber, synthetic fibers, and supplier consignment batches.">Track yarn counts (Denier/Ne), raw cotton fiber, synthetic fibers, and supplier consignment batches.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mb-4">
                    <div class="npv-highlight-card">
                        ...
                        <div>
                            <h4 class="npv-hl-title np-trans" data-en="Weaving Loom &amp; Knitting Run Monitoring">Weaving Loom &amp; Knitting Run Monitoring</h4>
                            <p class="npv-hl-desc np-trans" data-en="Record loom efficiency, grey fabric meter output, warp/weft breakages, and operator shift logs.">Record loom efficiency, grey fabric meter output, warp/weft breakages, and operator shift logs.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mb-4">
                    <div class="npv-highlight-card">
                        <div class="npv-hl-icon"><i class="fa-solid fa-flask"></i></div>
                        <div>
                            <h4 class="npv-hl-title np-trans" data-en="Dyeing &amp; Finishing Recipe Batches">Dyeing &amp; Finishing Recipe Batches</h4>
                            <p class="npv-hl-desc np-trans" data-en="Manage dye chemicals, color matching recipes, water bath ratios, and finished fabric quality inspection.">Manage dye chemicals, color matching recipes, water bath ratios, and finished fabric quality inspection.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mb-4">
                    <div class="npv-highlight-card">
                        <div class="npv-hl-icon"><i class="fa-solid fa-scroll"></i></div>
                        <div>
                            <h4 class="npv-hl-title np-trans" data-en="Fabric Roll Meter &amp; Than (थान) Management">Fabric Roll Meter &amp; Than (थान) Management</h4>
                            <p class="npv-hl-desc np-trans" data-en="Track meter length, fabric width, roll defects, and wholesale dispatch to garment manufacturers and markets.">Track meter length, fabric width, roll defects, and wholesale dispatch to garment manufacturers and markets.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="py-5 bg-white">
        <div class="container">
            <div class="row align-items-center mb-5">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    ...
                    <ul class="list-unstyled mt-4" style="line-height: 2.2; font-size: 16px;">
                        <li class="np-trans" data-en="Fabric Weaving &amp; Knitting Mills"><i class="fa-solid fa-circle-check text-danger me-2"></i> Fabric Weaving &amp; Knitting Mills</li><li class="np-trans" data-en="Yarn Spinning &amp; Twisting Plants"><i class="fa-solid fa-circle-check text-danger me-2"></i> Yarn Spinning &amp; Twisting Plants</li><li class="np-trans" data-en="Textile Dyeing &amp; Processing Houses"><i class="fa-solid fa-circle-check text-danger me-2"></i> Textile Dyeing &amp; Processing Houses</li><li class="np-trans" data-en="Wholesale Fabric Merchants (Indra Chowk / New Road)"><i class="fa-solid fa-circle-check text-danger me-2"></i> Wholesale Fabric Merchants (Indra Chowk / New Road)</li><li class="np-trans" data-en="Curtain, Upholstery &amp; Home Textile Traders"><i class="fa-solid fa-circle-check text-danger me-2"></i> Curtain, Upholstery &amp; Home Textile Traders</li><li class="np-trans" data-en="Technical Fabric &amp; Geotextile Manufacturers"><i class="fa-solid fa-circle-check text-danger me-2"></i> Technical Fabric &amp; Geotextile Manufacturers</li>
                    </ul>
                </div>
                <div class="col-lg-6">
            ...
            <div class="pt-4 border-top">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Yarn Lot &amp; Cone Management">Yarn Lot &amp; Cone Management</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Loom Production Tracking">Loom Production Tracking</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Dyeing Chemical Recipes">Dyeing Chemical Recipes</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Fabric Than (थान) &amp; Meter Inventory">Fabric Than (थान) &amp; Meter Inventory</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Defect Inspection Grading">Defect Inspection Grading</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Dealer Credit Ledgers">Dealer Credit Ledgers</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Wholesale Tax Invoicing">Wholesale Tax Invoicing</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Mill Costing Analytics">Mill Costing Analytics</span></div></div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-5" style="background: linear-gradient(135deg, #dc2626 0%, #991b1b 100%); color: #fff;">
        <div class="container text-center">
            ...
            <p class="mx-auto mb-4 text-white-50" style="max-width: 680px; font-size: 17px;">Experience a personalized 15-minute system walkthrough calibrated for Textile Mills &amp; Fabric Trading ERP Software in Nepal.</p>
