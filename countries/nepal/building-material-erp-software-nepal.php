...
$pageTitle = "Building Material ERP Software in Nepal | Hardware, Cement & Steel ERP";
$pageDescription = "ERP software in Nepal for building material traders, hardware shops, cement and steel distributors, sanitaryware and electrical wholesalers.";
$pageKeywords = "Building material ERP Nepal, Hardware shop software Nepal, Cement steel wholesale Kathmandu, Sanitaryware ERP Nepal, Paint store software Pokhara, Construction supplies ERP Nepal";
$pageCanonical = "https://www.digifysoft.in/building-material-erp-software-nepal";
...
<div class="npv-wrapper">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-7 mb-4 mb-lg-0">
                    ...
                    <br>
                    <div class="npv-badge">
                        <span>🧱 Hardware, Cement & Steel Commercial Suite</span>
                    </div>
                    <h1 class="np-trans" data-en="Building Material &amp; Hardware ERP Software in Nepal" data-np="नेपालमा हार्डवेयर तथा निर्माण सामग्री (Building Material) ERP सफ्टवेयर">
                        Building Material &amp; Hardware ERP Software in Nepal
                    </h1>
                    <p class="npv-hero-desc np-trans" data-en="Manage heavy tonnage cement and steel bundles, plumbing fittings, electrical inventory, credit sales to contractors, and delivery truck dispatches." data-np="सिमेन्ट, रड, हार्डवेयर, सेनेटरी र पेन्ट पसलहरूका लागि वजन रूपान्तरण, कन्ट्र्याक्टर उधारो खाता र डेलिभरी चालान सफ्टवेयर।">
                        Manage heavy tonnage cement and steel bundles, plumbing fittings, electrical inventory, credit sales to contractors, and delivery truck dispatches.
                    </p>
                ...
                <div class="col-lg-5">
                    <div class="npv-lead-card">
                        ...
                        <p class="np-trans" data-en="Tailored for Building Material &amp; Hardware ERP Software in Nepal across Nepal." data-np="नेपालभरका व्यवसायहरूका लागि अनुकूलित ERP प्रणाली।">Tailored for Building Material &amp; Hardware ERP Software in Nepal across Nepal.</p>
                        
                        <form action="send_mail.php" method="POST" id="nepalVerticalLeadForm">
                            <input type="hidden" name="source" value="Nepal Building Material &amp; Hardware ERP Software in Nepal Page">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 mb-4">
                    <div class="npv-highlight-card">
                        <div class="npv-hl-icon"><i class="fa-solid fa-weight-hanging"></i></div>
                        <div>
                            <h4 class="npv-hl-title np-trans" data-en="TMT Steel Weight vs Piece Conversion">TMT Steel Weight vs Piece Conversion</h4>
                            <p class="npv-hl-desc np-trans" data-en="Automatically convert TMT rebar bundles, metric tons, and standard meter lengths during billing.">Automatically convert TMT rebar bundles, metric tons, and standard meter lengths during billing.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mb-4">
                    <div class="npv-highlight-card">
                        <div class="npv-hl-icon"><i class="fa-solid fa-cubes-stacked"></i></div>
                        <div>
                            <h4 class="npv-hl-title np-trans" data-en="Cement Bag &amp; Aggregate Fleet Dispatch">Cement Bag &amp; Aggregate Fleet Dispatch</h4>
                            <p class="npv-hl-desc np-trans" data-en="Track cement batch brand inventory, bag breakage returns, and tipper truck delivery challans.">Track cement batch brand inventory, bag breakage returns, and tipper truck delivery challans.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mb-4">
                    <div class="npv-highlight-card">
                        <div class="npv-hl-icon"><i class="fa-solid fa-file-invoice"></i></div>
                        <div>
                            <h4 class="npv-hl-title np-trans" data-en="Contractor Credit Ledgers &amp; Outstanding Aging">Contractor Credit Ledgers &amp; Outstanding Aging</h4>
                            <p class="npv-hl-desc np-trans" data-en="Maintain credit limits for builders and contractors, print monthly statements, and record partial settlements.">Maintain credit limits for builders and contractors, print monthly statements, and record partial settlements.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mb-4">
                    <div class="npv-highlight-card">
                        <div class="npv-hl-icon"><i class="fa-solid fa-list-ol"></i></div>
                        <div>
                            <h4 class="npv-hl-title np-trans" data-en="Massive Hardware SKU Cataloging">Massive Hardware SKU Cataloging</h4>
                            <p class="npv-hl-desc np-trans" data-en="Organize thousands of plumbing, sanitary, electrical, paint, and power tool SKUs with ease.">Organize thousands of plumbing, sanitary, electrical, paint, and power tool SKUs with ease.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="py-5 bg-white">
        <div class="container">
            <div class="row align-items-center mb-5">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    ...
                    <ul class="list-unstyled mt-4" style="line-height: 2.2; font-size: 16px;">
                        <li class="np-trans" data-en="Cement &amp; TMT Steel Wholesalers"><i class="fa-solid fa-circle-check text-danger me-2"></i> Cement &amp; TMT Steel Wholesalers</li><li class="np-trans" data-en="Hardware &amp; Sanitaryware Showrooms"><i class="fa-solid fa-circle-check text-danger me-2"></i> Hardware &amp; Sanitaryware Showrooms</li><li class="np-trans" data-en="Electrical &amp; Wiring Material Dealers"><i class="fa-solid fa-circle-check text-danger me-2"></i> Electrical &amp; Wiring Material Dealers</li><li class="np-trans" data-en="Paints, Coatings &amp; Chemical Stockists"><i class="fa-solid fa-circle-check text-danger me-2"></i> Paints, Coatings &amp; Chemical Stockists</li><li class="np-trans" data-en="Plywood, Timber &amp; Glass Merchants"><i class="fa-solid fa-circle-check text-danger me-2"></i> Plywood, Timber &amp; Glass Merchants</li><li class="np-trans" data-en="Tiles &amp; Marble Showrooms"><i class="fa-solid fa-circle-check text-danger me-2"></i> Tiles &amp; Marble Showrooms</li>
                    </ul>
                </div>
                <div class="col-lg-6">
            ...
            <div class="pt-4 border-top">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Steel Metric Ton Conversion">Steel Metric Ton Conversion</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Cement Bag Inventory">Cement Bag Inventory</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Contractor Credit Ledgers">Contractor Credit Ledgers</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Wholesale Delivery Challans">Wholesale Delivery Challans</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Multi-Brand Pricing Matrices">Multi-Brand Pricing Matrices</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Supplier Purchase Ledgers">Supplier Purchase Ledgers</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Hardware SKU Management">Hardware SKU Management</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Outstanding Debt Aging">Outstanding Debt Aging</span></div></div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-5" style="background: linear-gradient(135deg, #dc2626 0%, #991b1b 100%); color: #fff;">
        <div class="container text-center">
            ...
            <p class="mx-auto mb-4 text-white-50" style="max-width: 680px; font-size: 17px;">Experience a personalized 15-minute system walkthrough calibrated for Building Material &amp; Hardware ERP Software in Nepal.</p>
