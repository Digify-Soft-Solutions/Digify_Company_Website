...
$pageTitle = "Construction ERP Software in Nepal | Project, Material & Site ERP";
$pageDescription = "Construction and project ERP software in Nepal for building contractors, civil engineers, road builders, and infrastructure developers. Manage site materials, machinery, and sub-contractors.";
$pageKeywords = "Construction ERP Nepal, Builder software Nepal, Project management ERP Kathmandu, Construction material inventory Nepal, Contractor billing software Nepal, Civil engineering ERP Nepal";
$pageCanonical = "https://www.digifysoft.in/construction-erp-software-nepal";
...
<div class="npv-wrapper">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-7 mb-4 mb-lg-0">
                    ...
                    <br>
                    <div class="npv-badge">
                        <span>🏗️ Built for Nepal Construction Contractors & Developers</span>
                    </div>
                    <h1 class="np-trans" data-en="Construction &amp; Project ERP Software in Nepal" data-np="नेपालमा निर्माण तथा कन्स्ट्रक्सन (Construction) ERP सफ्टवेयर">
                        Construction &amp; Project ERP Software in Nepal
                    </h1>
                    <p class="npv-hero-desc np-trans" data-en="Streamline multi-site building materials, cement/steel procurement, equipment rentals, sub-contractor measurement sheets, and project profitability across Nepal." data-np="भवन निर्माण, सडक, पुल तथा पूर्वाधार निर्माण व्यवसायीहरूका लागि सिमेन्ट-रड मौज्दात, मेसिनरी डिजेल खर्च र ठेकेदार बिलिङ सफ्टवेयर।">
                        Streamline multi-site building materials, cement/steel procurement, equipment rentals, sub-contractor measurement sheets, and project profitability across Nepal.
                    </p>
                ...
                <div class="col-lg-5">
                    <div class="npv-lead-card">
                        ...
                        <p class="np-trans" data-en="Tailored for Construction &amp; Project ERP Software in Nepal across Nepal." data-np="नेपालभरका व्यवसायहरूका लागि अनुकूलित ERP प्रणाली।">Tailored for Construction &amp; Project ERP Software in Nepal across Nepal.</p>
                        
                        <form action="send_mail.php" method="POST" id="nepalVerticalLeadForm">
                            <input type="hidden" name="source" value="Nepal Construction &amp; Project ERP Software in Nepal Page">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 mb-4">
                    <div class="npv-highlight-card">
                        <div class="npv-hl-icon"><i class="fa-solid fa-cubes"></i></div>
                        <div>
                            <h4 class="npv-hl-title np-trans" data-en="Site-Wise Cement, Steel &amp; Aggregate Inventory">Site-Wise Cement, Steel &amp; Aggregate Inventory</h4>
                            <p class="npv-hl-desc np-trans" data-en="Prevent on-site material theft and wastage with multi-site stock receipt and consumption logging.">Prevent on-site material theft and wastage with multi-site stock receipt and consumption logging.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mb-4">
                    <div class="npv-highlight-card">
                        <div class="npv-hl-icon"><i class="fa-solid fa-truck-pickup"></i></div>
                        <div>
                            <h4 class="npv-hl-title np-trans" data-en="Heavy Equipment &amp; Vehicle Fuel Logging">Heavy Equipment &amp; Vehicle Fuel Logging</h4>
                            <p class="npv-hl-desc np-trans" data-en="Track excavators, loaders, and tipper running hours, diesel consumption, and rental billing.">Track excavators, loaders, and tipper running hours, diesel consumption, and rental billing.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mb-4">
                    <div class="npv-highlight-card">
                        <div class="npv-hl-icon"><i class="fa-solid fa-person-digging"></i></div>
                        <div>
                            <h4 class="npv-hl-title np-trans" data-en="Sub-Contractor Work &amp; Measurement Billing">Sub-Contractor Work &amp; Measurement Billing</h4>
                            <p class="npv-hl-desc np-trans" data-en="Process running bills based on physical site measurements, retention money, and labor muster rolls.">Process running bills based on physical site measurements, retention money, and labor muster rolls.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mb-4">
                    <div class="npv-highlight-card">
                        <div class="npv-hl-icon"><i class="fa-solid fa-chart-pie"></i></div>
                        <div>
                            <h4 class="npv-hl-title np-trans" data-en="Live Project Profit &amp; Loss Accounting">Live Project Profit &amp; Loss Accounting</h4>
                            <p class="npv-hl-desc np-trans" data-en="Evaluate project-by-project profit margins by comparing actual material, labor, and machine costs.">Evaluate project-by-project profit margins by comparing actual material, labor, and machine costs.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="py-5 bg-white">
        <div class="container">
            <div class="row align-items-center mb-5">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    ...
                    <ul class="list-unstyled mt-4" style="line-height: 2.2; font-size: 16px;">
                        <li class="np-trans" data-en="General Building &amp; Commercial Contractors"><i class="fa-solid fa-circle-check text-danger me-2"></i> General Building &amp; Commercial Contractors</li><li class="np-trans" data-en="Road, Bridge &amp; Highway Developers"><i class="fa-solid fa-circle-check text-danger me-2"></i> Road, Bridge &amp; Highway Developers</li><li class="np-trans" data-en="Civil Engineering &amp; Infrastructure Firms"><i class="fa-solid fa-circle-check text-danger me-2"></i> Civil Engineering &amp; Infrastructure Firms</li><li class="np-trans" data-en="Real Estate &amp; Housing Developers"><i class="fa-solid fa-circle-check text-danger me-2"></i> Real Estate &amp; Housing Developers</li><li class="np-trans" data-en="Interior Finishing &amp; Fit-out Contractors"><i class="fa-solid fa-circle-check text-danger me-2"></i> Interior Finishing &amp; Fit-out Contractors</li><li class="np-trans" data-en="Specialized Earthmoving &amp; Excavation Companies"><i class="fa-solid fa-circle-check text-danger me-2"></i> Specialized Earthmoving &amp; Excavation Companies</li>
                    </ul>
                </div>
                <div class="col-lg-6">
            ...
            <div class="pt-4 border-top">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Site Material Receipt &amp; Indents">Site Material Receipt &amp; Indents</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Cement, TMT Steel &amp; Sand Stock">Cement, TMT Steel &amp; Sand Stock</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Sub-Contractor Running Bills">Sub-Contractor Running Bills</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Machinery Log &amp; Fuel Consumption">Machinery Log &amp; Fuel Consumption</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Labor Muster &amp; Daily Wage Records">Labor Muster &amp; Daily Wage Records</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Site Expense Vouchers">Site Expense Vouchers</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Project Budget vs Actual Analytics">Project Budget vs Actual Analytics</span></div></div><div class="col-md-6 col-lg-3 mb-3"><div class="npv-feature-pill"><i class="fa-solid fa-check text-success me-2"></i><span class="np-trans" data-en="Supplier Purchase Ledgers">Supplier Purchase Ledgers</span></div></div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-5" style="background: linear-gradient(135deg, #dc2626 0%, #991b1b 100%); color: #fff;">
        <div class="container text-center">
            ...
            <p class="mx-auto mb-4 text-white-50" style="max-width: 680px; font-size: 17px;">Experience a personalized 15-minute system walkthrough calibrated for Construction &amp; Project ERP Software in Nepal.</p>
