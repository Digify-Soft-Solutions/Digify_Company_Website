...
$pageTitle = "Wholesale ERP Software in Oman | Bulk Orders & Credit Management";
$pageDescription = "Comprehensive Wholesale ERP software in Oman for bulk product purchasing, customer credit limits, inventory valuation, and multi-branch warehouse distribution.";
$pageKeywords = "Wholesale ERP Software in Oman, Bulk Orders & Credit Management, ERP software Oman, Oman VAT, Fawtara ERP, Oman Tax Authority, Digify ERP";
$pageCanonical = "https://www.digifysoft.in/wholesale-erp-software-oman";
...
<div class="om-page-wrapper">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-7 mb-4 mb-lg-0">
                    ...
                    <h1>Wholesale ERP Software in Oman</h1>
                    <div class="om-hero-sub">Wholesale Customers, Bulk Purchasing, Credit Terms &amp; Warehouse Logistics</div>
                    <p class="om-hero-desc">Manage wholesale clients, bulk container purchasing, multi-location stock, credit accounts, and supplier disbursements from one centralized ERP system.</p>
                ...
                <div class="col-lg-5">
                    <div class="p-4 bg-white rounded-4 shadow-lg text-dark">
                        ...
                        <form action="send_mail.php" method="POST">
                            <input type="hidden" name="source" value="Wholesale ERP Software in Oman">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
                        ...
                        <p>Manage goods transfer orders between central wholesale yards and retail supply points.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
                        ...
                        <h4>B2B Tax Invoicing &amp; 5% VAT</h4>
                        <p>Compliant A4 tax invoices with full buyer Tax ID details, itemized tax rates, and QR codes.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="p-4 bg-light-om rounded-4 border">
                        ...
                        <h6 class="fw-bold text-dark mb-2">Can we manage Post-Dated Cheques (PDC) received from wholesale clients in Oman?</h6>
    ...
    <section class="py-5" style="background: linear-gradient(135deg, #091b2e 0%, #0d3824 100%); color: #ffffff;">
        <div class="container text-center py-4">
            <h2 class="fw-bold mb-3">Deploy Wholesale ERP Software in Oman</h2>
