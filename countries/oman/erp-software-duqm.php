...
$pageTitle = "ERP Software in Duqm | Special Economic Zone (SEZAD) & Heavy Industry";
$pageDescription = "Enterprise ERP software in Duqm Special Economic Zone (SEZAD) for mega-project contractors, marine fisheries, port logistics, and industrial suppliers.";
$pageKeywords = "ERP Software in Duqm, Special Economic Zone (SEZAD) & Heavy Industry, ERP software Oman, Oman VAT, Fawtara ERP, Oman Tax Authority, Digify ERP";
$pageCanonical = "https://www.digifysoft.in/erp-software-duqm";
...
<div class="om-page-wrapper">
            ...
            <div class="row align-items-center">
                <div class="col-lg-7 mb-4 mb-lg-0">
                    <div class="om-hero-badge">
                        <span>🇴🇲 SEZAD Mega-Projects &amp; Industrial Future</span>
                    </div>
                    <h1>ERP Software in Duqm Special Economic Zone (SEZAD)</h1>
                    <div class="om-hero-sub">SEZAD Contractors, Marine Fisheries, Port Logistics &amp; Heavy Supplies</div>
                    <p class="om-hero-desc">Power operations across the multi-billion dollar Duqm Special Economic Zone. Digify ERP coordinates mega-project contractor billing, marine fisheries processing, heavy industrial supplies, bonded yard inventory, and port logistics in Duqm.</p>
                    ...
                    <div class="pt-2">
                        ...
                        <div class="d-flex flex-wrap gap-2"><span class="badge bg-white bg-opacity-15 text-white border border-light border-opacity-25 px-3 py-2 fw-semibold"><i class="fa-solid fa-check text-warning me-1"></i> Mega-Project Contractors</span><span class="badge bg-white bg-opacity-15 text-white border border-light border-opacity-25 px-3 py-2 fw-semibold"><i class="fa-solid fa-check text-warning me-1"></i> Marine Fisheries Processors</span><span class="badge bg-white bg-opacity-15 text-white border border-light border-opacity-25 px-3 py-2 fw-semibold"><i class="fa-solid fa-check text-warning me-1"></i> Port Logistics Operators</span><span class="badge bg-white bg-opacity-15 text-white border border-light border-opacity-25 px-3 py-2 fw-semibold"><i class="fa-solid fa-check text-warning me-1"></i> Heavy Equipment Suppliers</span><span class="badge bg-white bg-opacity-15 text-white border border-light border-opacity-25 px-3 py-2 fw-semibold"><i class="fa-solid fa-check text-warning me-1"></i> Industrial Fabrication Plants</span><span class="badge bg-white bg-opacity-15 text-white border border-light border-opacity-25 px-3 py-2 fw-semibold"><i class="fa-solid fa-check text-warning me-1"></i> Camp Facility Management</span></div>
                    </div>
                </div>
                ...
                <div class="col-lg-5">
                    <div class="p-4 bg-white rounded-4 shadow-lg text-dark">
                        ...
                        <form action="send_mail.php" method="POST">
                            <input type="hidden" name="source" value="ERP Software in Duqm Special Economic Zone (SEZAD)">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
                        ...
                        <h4>SEZAD Contractor Progress &amp; BOQ Budgeting</h4>
                        <p>Manage construction milestone billing, site material requisitions, and subcontractor accounts for SEZAD mega-projects.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
                        ...
                        <h4>Duqm Marine Fisheries &amp; Processing Cluster</h4>
                        <p>Track large-scale fish receiving at Duqm Port, cold storage batching, processing yields, and container export shipping.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
                        ...
                        <h4>Duqm Port Logistics &amp; Bonded Yard Control</h4>
                        <p>Manage heavy container receiving, customs clearance documents, and open-yard industrial storage.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
                        ...
                        <h4>Heavy Equipment &amp; Machinery Maintenance</h4>
                        <p>Track maintenance schedules, spare parts consumption, and operator logs for cranes, excavators, and generators.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
                        ...
                        <h4>B2B Industrial Invoicing &amp; 5% VAT</h4>
                        <p>Generate compliant tax invoices for major energy, petrochemical, and construction conglomerates in OMR.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
                        ...
                        <h4>Worker Camp &amp; Staff Payroll Management</h4>
                        <p>Manage remote workforce attendance, shift rotations, allowances, and bank salary batch transfers.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="p-4 bg-light-om rounded-4 border">
                        ...
                        <h6 class="fw-bold text-dark mb-2">How does Digify support contractors and industrial suppliers operating in Duqm SEZAD?</h6>
                        <p class="text-muted small mb-0" style="line-height: 1.7;">Digify provides project-based milestone billing, site material indents, heavy equipment maintenance logs, and multi-location inventory synchronization.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-5" style="background: linear-gradient(135deg, #091b2e 0%, #0d3824 100%); color: #ffffff;">
        <div class="container text-center py-4">
            <h2 class="fw-bold mb-3">Deploy ERP Software in Duqm Special Economic Zone (SEZAD)</h2>
