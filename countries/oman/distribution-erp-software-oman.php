...
$pageTitle = "Distribution ERP Software in Oman | Multi-Warehouse & Wholesale";
$pageDescription = "High-performance Distribution ERP software in Oman for FMCG, food, electronics, auto parts, and wholesale distributors with van sales and credit tracking.";
$pageKeywords = "Distribution ERP Software in Oman, Multi-Warehouse & Wholesale, ERP software Oman, Oman VAT, Fawtara ERP, Oman Tax Authority, Digify ERP";
$pageCanonical = "https://www.digifysoft.in/distribution-erp-software-oman";
...
<div class="om-page-wrapper">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-7 mb-4 mb-lg-0">
                    ...
                    <h1>Distribution ERP Software in Oman</h1>
                    <div class="om-hero-sub">High-Volume Distribution, Van Sales, Credit Control &amp; Warehouses</div>
                    <p class="om-hero-desc">Manage high-volume distribution operations across Muscat, Sohar, Salalah, Nizwa, and Duqm through centralized inventory, van delivery routes, customer credit tracking, and automated receivables.</p>
                ...
                <div class="col-lg-5">
                    <div class="p-4 bg-white rounded-4 shadow-lg text-dark">
                        ...
                        <form action="send_mail.php" method="POST">
                            <input type="hidden" name="source" value="Distribution ERP Software in Oman">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
                        ...
                        <h4>Multi-Warehouse &amp; Hub Stock</h4>
                        <p>Real-time stock visibility across central distribution facilities in Muscat, regional depots in Sohar/Salalah, and delivery vans.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
                        ...
                        <h4>Tiered Pricing &amp; Volume Schemes</h4>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
                        ...
                        <h4>B2B Electronic Tax Invoicing</h4>
                        <p>Issue official bilingual tax invoices with customer Tax ID, dynamic QR codes, and 5% VAT computation.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-5" style="background: linear-gradient(135deg, #091b2e 0%, #0d3824 100%); color: #ffffff;">
        <div class="container text-center py-4">
            <h2 class="fw-bold mb-3">Deploy Distribution ERP Software in Oman</h2>
