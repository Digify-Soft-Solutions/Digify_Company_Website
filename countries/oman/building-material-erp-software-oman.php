...
$pageTitle = "Building Material ERP Software in Oman | Steel, Cement & Hardware";
$pageDescription = "Comprehensive Building Material ERP software in Oman for cement dealers, structural steel stockists, tile & sanitary ware traders, and hardware distributors.";
$pageKeywords = "Building Material ERP Software in Oman, Steel, Cement & Hardware, ERP software Oman, Oman VAT, Fawtara ERP, Oman Tax Authority, Digify ERP";
$pageCanonical = "https://www.digifysoft.in/building-material-erp-software-oman";
...
<div class="om-page-wrapper">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-7 mb-4 mb-lg-0">
                    ...
                    <h1>Building Material ERP Software in Oman</h1>
                    <div class="om-hero-sub">Dimensional Stock (Length/Weight), Truck Deliveries, Contractor Credit &amp; Pricing</div>
                    <p class="om-hero-desc">Manage heavy building materials, structural steel, cement bags, ceramic tiles, plumbing supplies, and hardware tools across trade counters and distribution yards with Digify Building Material ERP.</p>
                ...
                <div class="col-lg-5">
                    <div class="p-4 bg-white rounded-4 shadow-lg text-dark">
                        ...
                        <form action="send_mail.php" method="POST">
                            <input type="hidden" name="source" value="Building Material ERP Software in Oman">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
                        ...
                        <p>Manage bulk cement, sand, gravel, steel rebar bundles, and masonry blocks across open yards with forklift routing.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
                        ...
                        <h4>Oman 5% VAT &amp; Electronic Tax Invoicing</h4>
                        <p>Issue official tax invoices with buyer Tax ID, sequential tax numbering, and itemized dimensional descriptions.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
    ...
    <section class="py-5" style="background: linear-gradient(135deg, #091b2e 0%, #0d3824 100%); color: #ffffff;">
        <div class="container text-center py-4">
            <h2 class="fw-bold mb-3">Deploy Building Material ERP Software in Oman</h2>
