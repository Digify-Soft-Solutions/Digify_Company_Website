...
$pageTitle = "Workshop ERP Software in Oman | Auto Repair, Job Cards & Spare Parts";
$pageDescription = "Dedicated Workshop ERP software in Oman for automotive garages, car repair shops, tyre service centers, and equipment maintenance workshops.";
$pageKeywords = "Workshop ERP Software in Oman, Auto Repair, Job Cards & Spare Parts, ERP software Oman, Oman VAT, Fawtara ERP, Oman Tax Authority, Digify ERP";
$pageCanonical = "https://www.digifysoft.in/workshop-erp-software-oman";
...
<div class="om-page-wrapper">
            ...
            <div class="row align-items-center">
                <div class="col-lg-7 mb-4 mb-lg-0">
                    <div class="om-hero-badge">
                        <span>🇴🇲 Automotive Workshop &amp; Repair Hub</span>
                    </div>
                    <h1>Workshop ERP Software in Oman</h1>
                    <div class="om-hero-sub">Digital Job Cards, Vehicle Records, Mechanic Labor &amp; Spare Parts Billing</div>
                    <p class="om-hero-desc">Modernize your auto repair garage or service center in Oman. Digify Workshop ERP tracks vehicle registration numbers, digital job cards, technician labor charges, spare parts usage, and combined tax invoices.</p>
                    ...
                    <div class="pt-2">
                        ...
                        <div class="d-flex flex-wrap gap-2"><span class="badge bg-white bg-opacity-15 text-white border border-light border-opacity-25 px-3 py-2 fw-semibold"><i class="fa-solid fa-check text-warning me-1"></i> Auto Repair Garages</span><span class="badge bg-white bg-opacity-15 text-white border border-light border-opacity-25 px-3 py-2 fw-semibold"><i class="fa-solid fa-check text-warning me-1"></i> Tyre &amp; Alignment Shops</span><span class="badge bg-white bg-opacity-15 text-white border border-light border-opacity-25 px-3 py-2 fw-semibold"><i class="fa-solid fa-check text-warning me-1"></i> AC &amp; Electrical Workshops</span><span class="badge bg-white bg-opacity-15 text-white border border-light border-opacity-25 px-3 py-2 fw-semibold"><i class="fa-solid fa-check text-warning me-1"></i> Diesel &amp; Heavy Equipment Repair</span><span class="badge bg-white bg-opacity-15 text-white border border-light border-opacity-25 px-3 py-2 fw-semibold"><i class="fa-solid fa-check text-warning me-1"></i> Car Detailing &amp; Tuning</span><span class="badge bg-white bg-opacity-15 text-white border border-light border-opacity-25 px-3 py-2 fw-semibold"><i class="fa-solid fa-check text-warning me-1"></i> Fleet Maintenance Yards</span></div>
                    </div>
                </div>
                ...
                <div class="col-lg-5">
                    <div class="p-4 bg-white rounded-4 shadow-lg text-dark">
                        ...
                        <form action="send_mail.php" method="POST">
                            <input type="hidden" name="source" value="Workshop ERP Software in Oman">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
                        ...
                        <h4>Vehicle Registration &amp; Customer Profile</h4>
                        <p>Log vehicle plate number, chassis VIN, make/model, odometer mileage, and customer contact details.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
                        ...
                        <h4>Digital Job Cards &amp; Repair Estimates</h4>
                        <p>Create detailed job cards with initial customer complaint, mechanic inspection findings, and cost estimates.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
                        ...
                        <p>Live stock lookup for filters, brake pads, engine oils, and batteries with instant cost and margin visibility.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
                        ...
                        <h4>Mechanic Labor &amp; Commission Tracking</h4>
                        <p>Track technician hours spent on repairs and calculate individual mechanic incentive commissions.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
                        ...
                        <h4>Combined Parts &amp; Labor Invoicing</h4>
                        <p>Generate clear bilingual tax invoices detailing spare parts used alongside labor fees with 5% VAT.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
                        ...
                        <p>Access past maintenance records, replaced components, and upcoming service reminder alerts by vehicle license plate.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="p-4 bg-light-om rounded-4 border">
                        ...
                        <h6 class="fw-bold text-dark mb-2">Can customers view their vehicle service history and itemized repair costs?</h6>
                        <p class="text-muted small mb-0" style="line-height: 1.7;">Yes. Digify maintains a complete digital vehicle service history by license plate number, showing all past repair dates, parts replaced, and invoices.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-5" style="background: linear-gradient(135deg, #091b2e 0%, #0d3824 100%); color: #ffffff;">
        <div class="container text-center py-4">
            <h2 class="fw-bold mb-3">Deploy Workshop ERP Software in Oman</h2>
