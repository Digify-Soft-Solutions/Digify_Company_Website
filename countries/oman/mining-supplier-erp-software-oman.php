...
$pageTitle = "Mining & Industrial Supplier ERP Software in Oman | Equipment & Parts";
$pageDescription = "Specialized Mining and Industrial Supplier ERP software in Oman for heavy equipment spare parts, gypsum/chromite logistics, hydraulic consumables, and contractors.";
$pageKeywords = "Mining & Industrial Supplier ERP Software in Oman, Equipment & Parts, ERP software Oman, Oman VAT, Fawtara ERP, Oman Tax Authority, Digify ERP";
$pageCanonical = "https://www.digifysoft.in/mining-supplier-erp-software-oman";
...
<div class="om-page-wrapper">
            ...
            <div class="row align-items-center">
                <div class="col-lg-7 mb-4 mb-lg-0">
                    <div class="om-hero-badge">
                        <span>🇴🇲 Minerals, Mining &amp; Industrial Supply</span>
                    </div>
                    <h1>Mining &amp; Industrial Supplier ERP Software in Oman</h1>
                    <div class="om-hero-sub">Heavy Equipment Parts, Industrial Consumables, Yanqul/Sohar Supply &amp; Maintenance</div>
                    <p class="om-hero-desc">Support Oman&#039;s mineral development (gypsum, copper, chromite, limestone) and industrial zones. Digify Mining Supplier ERP manages heavy machinery spare parts, hydraulic hoses, explosive storage permits, equipment maintenance, and B2B industrial sales in Sohar, Yanqul, and Duqm.</p>
                    ...
                    <div class="pt-2">
                        ...
                        <div class="d-flex flex-wrap gap-2"><span class="badge bg-white bg-opacity-15 text-white border border-light border-opacity-25 px-3 py-2 fw-semibold"><i class="fa-solid fa-check text-warning me-1"></i> Mining Equipment Suppliers</span><span class="badge bg-white bg-opacity-15 text-white border border-light border-opacity-25 px-3 py-2 fw-semibold"><i class="fa-solid fa-check text-warning me-1"></i> Industrial Consumables Distributors</span><span class="badge bg-white bg-opacity-15 text-white border border-light border-opacity-25 px-3 py-2 fw-semibold"><i class="fa-solid fa-check text-warning me-1"></i> Quarry &amp; Crusher Operators</span><span class="badge bg-white bg-opacity-15 text-white border border-light border-opacity-25 px-3 py-2 fw-semibold"><i class="fa-solid fa-check text-warning me-1"></i> Heavy Equipment Maintenance</span><span class="badge bg-white bg-opacity-15 text-white border border-light border-opacity-25 px-3 py-2 fw-semibold"><i class="fa-solid fa-check text-warning me-1"></i> Hydraulic &amp; Pneumatic Suppliers</span><span class="badge bg-white bg-opacity-15 text-white border border-light border-opacity-25 px-3 py-2 fw-semibold"><i class="fa-solid fa-check text-warning me-1"></i> Mineral Logistics Companies</span></div>
                    </div>
                </div>
                ...
                <div class="col-lg-5">
                    <div class="p-4 bg-white rounded-4 shadow-lg text-dark">
                        ...
                        <form action="send_mail.php" method="POST">
                            <input type="hidden" name="source" value="Mining &amp; Industrial Supplier ERP Software in Oman">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
                        ...
                        <h4>Heavy Equipment Spare Parts Catalog</h4>
                        <p>Search excavator, crusher, and drill parts by OEM code, component specs, and heavy machinery interchange models.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
                        ...
                        <h4>Consumables &amp; Wear Parts Inventory</h4>
                        <p>Track crusher jaws, conveyor belts, lubricants, hydraulic oils, and grinding media with safety stock alerts.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
                        ...
                        <h4>Field Maintenance &amp; Equipment Repair Contracts</h4>
                        <p>Assign mobile service mechanics to quarry and mine sites, logging labor hours and replacement parts used.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
                        ...
                        <h4>Bulk Mineral Weighbridge &amp; Dispatch</h4>
                        <p>Integrate truck scale weighbridge gross/tare weights directly into bulk delivery notes and customer invoices.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
                        ...
                        <h4>B2B Corporate Invoicing &amp; 5% VAT</h4>
                        <p>Issue official tax invoices for mining conglomerates, port operators, and quarry contractors in OMR.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
                        ...
                        <h4>Multi-Currency International Procurement</h4>
                        <p>Issue purchase orders in USD, EUR, or JPY for specialized mining machinery components with landed cost allocation.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="p-4 bg-light-om rounded-4 border">
                        ...
                        <h6 class="fw-bold text-dark mb-2">Can Digify integrate weighbridge truck weights for bulk mineral delivery notes?</h6>
                        <p class="text-muted small mb-0" style="line-height: 1.7;">Yes. Weighbridge gross and tare truck readings can be entered directly to calculate net payload and generate delivery dispatch bills.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-5" style="background: linear-gradient(135deg, #091b2e 0%, #0d3824 100%); color: #ffffff;">
        <div class="container text-center py-4">
            <h2 class="fw-bold mb-3">Deploy Mining &amp; Industrial Supplier ERP Software in Oman</h2>
