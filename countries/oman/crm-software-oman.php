...
$pageTitle = "CRM Software in Oman | Sales Pipeline, Quotations & Customer Records";
$pageDescription = "Customer Relationship Management (CRM) software in Oman for B2B sales teams, lead tracking, bilingual quotations, sales pipelines, and customer history.";
$pageKeywords = "CRM Software in Oman, Sales Pipeline, Quotations & Customer Records, ERP software Oman, Oman VAT, Fawtara ERP, Oman Tax Authority, Digify ERP";
$pageCanonical = "https://www.digifysoft.in/crm-software-oman";
...
<div class="om-page-wrapper">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-7 mb-4 mb-lg-0">
                    ...
                    <h1>CRM Software in Oman for Sales &amp; Client Growth</h1>
                    <div class="om-hero-sub">Lead Management, Sales Pipelines, Bilingual Quotes &amp; Customer Lifecycle</div>
                    <p class="om-hero-desc">Empower your sales team across Oman. Digify CRM tracks incoming prospective leads, automates quotation generation, manages sales pipelines, records customer interaction histories, and converts winning deals directly into ERP orders.</p>
                ...
                <div class="col-lg-5">
                    <div class="p-4 bg-white rounded-4 shadow-lg text-dark">
                        ...
                        <form action="send_mail.php" method="POST">
                            <input type="hidden" name="source" value="CRM Software in Oman for Sales &amp; Client Growth">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
                        ...
                        <p>Generate polished Arabic and English sales quotations in seconds with pricing tiers, discounts, and payment terms.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
    ...
    <section class="py-5" style="background: linear-gradient(135deg, #091b2e 0%, #0d3824 100%); color: #ffffff;">
        <div class="container text-center py-4">
            <h2 class="fw-bold mb-3">Deploy CRM Software in Oman for Sales &amp; Client Growth</h2>
