...
$pageTitle = "FMCG ERP Software in Oman | Distribution, Van Sales & Food Supply";
$pageDescription = "High-velocity FMCG ERP software in Oman for fast-moving consumer goods distributors, beverage suppliers, and packaged food wholesalers.";
$pageKeywords = "FMCG ERP Software in Oman, Distribution, Van Sales & Food Supply, ERP software Oman, Oman VAT, Fawtara ERP, Oman Tax Authority, Digify ERP";
$pageCanonical = "https://www.digifysoft.in/fmcg-erp-software-oman";
...
<div class="om-page-wrapper">
            ...
            <div class="row align-items-center">
                <div class="col-lg-7 mb-4 mb-lg-0">
                    <div class="om-hero-badge">
                        <span>🇴🇲 FMCG &amp; Consumer Goods Distribution</span>
                    </div>
                    <h1>FMCG ERP Software in Oman</h1>
                    <div class="om-hero-sub">High-Turnover Stock, Van Delivery Routes, Scheme Promos &amp; Fast Billing</div>
                    <p class="om-hero-desc">Manage fast-moving food, beverages, personal care, and household products across Oman with real-time van route replenishment, promotional discount schemes, and automated credit collections.</p>
                    ...
                    <div class="pt-2">
                        ...
                        <div class="d-flex flex-wrap gap-2"><span class="badge bg-white bg-opacity-15 text-white border border-light border-opacity-25 px-3 py-2 fw-semibold"><i class="fa-solid fa-check text-warning me-1"></i> FMCG Wholesalers</span><span class="badge bg-white bg-opacity-15 text-white border border-light border-opacity-25 px-3 py-2 fw-semibold"><i class="fa-solid fa-check text-warning me-1"></i> Food &amp; Beverage Distributors</span><span class="badge bg-white bg-opacity-15 text-white border border-light border-opacity-25 px-3 py-2 fw-semibold"><i class="fa-solid fa-check text-warning me-1"></i> Personal Care Distributors</span><span class="badge bg-white bg-opacity-15 text-white border border-light border-opacity-25 px-3 py-2 fw-semibold"><i class="fa-solid fa-check text-warning me-1"></i> Household Goods Suppliers</span><span class="badge bg-white bg-opacity-15 text-white border border-light border-opacity-25 px-3 py-2 fw-semibold"><i class="fa-solid fa-check text-warning me-1"></i> Packaged Food Brands</span><span class="badge bg-white bg-opacity-15 text-white border border-light border-opacity-25 px-3 py-2 fw-semibold"><i class="fa-solid fa-check text-warning me-1"></i> Snack &amp; Confectionery Importers</span></div>
                    </div>
                </div>
                ...
                <div class="col-lg-5">
                    <div class="p-4 bg-white rounded-4 shadow-lg text-dark">
                        ...
                        <form action="send_mail.php" method="POST">
                            <input type="hidden" name="source" value="FMCG ERP Software in Oman">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
                        ...
                        <h4>Van Sales &amp; Route Replenishment</h4>
                        <p>Load delivery vans from central depots, track van inventory, and execute spot cash/credit sales at grocery stores.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
                        ...
                        <h4>Trade Schemes &amp; Promotional Discounts</h4>
                        <p>Configure buy-10-get-1-free offers, volume rebates, and seasonal price discounts with automated validation.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
                        ...
                        <h4>Batch / Expiry Date Tracking (FEFO)</h4>
                        <p>Pick oldest product batches first to prevent expired stock at retail partner shelves.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
                        ...
                        <h4>Retailer Credit Limits &amp; Aging Ledgers</h4>
                        <p>Monitor outstanding balances across hundreds of grocery accounts and enforce credit lock rules.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
                        ...
                        <h4>Sales Representative Target Tracking</h4>
                        <p>Track daily salesperson booking volumes, route visit compliance, and calculate sales commissions.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
                        ...
                        <p>Issue official bilingual tax invoices with customer Tax IDs and itemized VAT ledgers.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="p-4 bg-light-om rounded-4 border">
                        ...
                        <h6 class="fw-bold text-dark mb-2">Can sales reps manage van inventory and print thermal sales bills on site?</h6>
                        <p class="text-muted small mb-0" style="line-height: 1.7;">Yes. Digify supports mobile/tablet billing where sales reps can create delivery orders and print receipts directly from the van.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-5" style="background: linear-gradient(135deg, #091b2e 0%, #0d3824 100%); color: #ffffff;">
        <div class="container text-center py-4">
            <h2 class="fw-bold mb-3">Deploy FMCG ERP Software in Oman</h2>
