...
$pageTitle = "Logistics & Fleet ERP Software in Oman | Freight, Trips & Fleet";
$pageDescription = "End-to-end Logistics ERP software in Oman for transport companies, freight forwarders, 3PL warehouses, delivery fleets, and cross-border transport.";
$pageKeywords = "Logistics & Fleet ERP Software in Oman, Freight, Trips & Fleet, ERP software Oman, Oman VAT, Fawtara ERP, Oman Tax Authority, Digify ERP";
$pageCanonical = "https://www.digifysoft.in/logistics-erp-software-oman";
...
<div class="om-page-wrapper">
            ...
            <div class="row align-items-center">
                <div class="col-lg-7 mb-4 mb-lg-0">
                    <div class="om-hero-badge">
                        <span>🇴🇲 Regional Logistics &amp; Transport Gateway</span>
                    </div>
                    <h1>Logistics &amp; Fleet ERP Software in Oman</h1>
                    <div class="om-hero-sub">Trip Dispatches, Fleet Maintenance, Fuel Tracking &amp; 3PL Warehousing</div>
                    <p class="om-hero-desc">Support Oman&#039;s vision as a global logistics hub connecting Sohar, Salalah, Duqm, and Muscat. Digify Logistics ERP manages transport jobs, driver trip allowances, fuel logs, vehicle maintenance, and 3PL warehouse billing.</p>
                ...
                <div class="col-lg-5">
                    <div class="p-4 bg-white rounded-4 shadow-lg text-dark">
                        ...
                        <form action="send_mail.php" method="POST">
                            <input type="hidden" name="source" value="Logistics &amp; Fleet ERP Software in Oman">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
                        ...
                        <h4>Trip Dispatch &amp; Waybill Management</h4>
                        <p>Assign transport jobs, track driver trip allowances, generate electronic waybills, and log delivery timestamps.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
                        ...
                        <h4>Fuel Consumption &amp; Expense Auditing</h4>
                        <p>Monitor fuel card transactions, kilometers-per-liter efficiency, and route expenses per vehicle trip.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
                        ...
                        <p>Track oil change intervals, brake inspections, tyre rotation lifecycles, and vehicle insurance renewal dates.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
                        ...
                        <p>Manage pallet storage billing, inbound container de-stuffing, and pick-and-pack handling fees.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
                        ...
                        <h4>Customer Freight Billing &amp; 5% VAT</h4>
                        <p>Generate transportation invoices with standard 5% VAT or zero-rated international freight documentation.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="om-card h-100">
                        ...
                        <h4>Driver Settlement &amp; Payroll Integration</h4>
                        <p>Reconcile driver trip advances, road expenses, and monthly salary disbursements in OMR.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="p-4 bg-light-om rounded-4 border">
                        ...
                        <h6 class="fw-bold text-dark mb-2">Can Digify track fuel efficiency and maintenance costs for each truck in our fleet?</h6>
                        <p class="text-muted small mb-0" style="line-height: 1.7;">Yes. Every fuel receipt and maintenance invoice is logged against specific vehicle registration numbers, giving you exact cost-per-kilometer reporting.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-5" style="background: linear-gradient(135deg, #091b2e 0%, #0d3824 100%); color: #ffffff;">
        <div class="container text-center py-4">
            <h2 class="fw-bold mb-3">Deploy Logistics &amp; Fleet ERP Software in Oman</h2>
