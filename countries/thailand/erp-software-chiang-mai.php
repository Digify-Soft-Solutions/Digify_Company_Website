...
$pageTitle = "ERP Software in Chiang Mai | Tourism, Hospitality, Agriculture & Retail";
$pageDescription = "Tailored ERP software in Chiang Mai for boutique resorts, restaurants, organic agriculture, handicraft exports, and northern regional retail.";
$pageKeywords = "ERP Software in Chiang Mai, Tourism, Hospitality, Agriculture & Retail, ERP software Thailand, Thailand VAT, e-Tax Invoice, BOI Thailand, Digify ERP";
$pageCanonical = "https://www.digifysoft.in/erp-software-chiang-mai";
...
<div class="th-page-wrapper">
            ...
            <div class="row align-items-center">
                <div class="col-lg-7 mb-4 mb-lg-0">
                    <div class="th-hero-badge">
                        <span>🇹🇭 Northern Tourism, Agriculture &amp; Retail</span>
                    </div>
                    <h1>ERP Software in Chiang Mai &amp; Northern Thailand</h1>
                    <div class="th-hero-sub">Boutique Hotels, Organic Food Processing, Craft Exports &amp; Regional Retail</div>
                    <p class="th-hero-desc">Empower northern Thailand&#039;s dynamic economy. Digify ERP supports Chiang Mai enterprises across luxury hospitality, food processing, organic farming, handicraft manufacturing, and regional retail chains.</p>
                    ...
                    <div class="pt-2">
                        ...
                        <div class="d-flex flex-wrap gap-2"><span class="badge bg-white bg-opacity-15 text-white border border-light border-opacity-25 px-3 py-2 fw-semibold"><i class="fa-solid fa-check text-warning me-1"></i> Boutique Resorts &amp; Hotels</span><span class="badge bg-white bg-opacity-15 text-white border border-light border-opacity-25 px-3 py-2 fw-semibold"><i class="fa-solid fa-check text-warning me-1"></i> Coffee &amp; Tea Producers</span><span class="badge bg-white bg-opacity-15 text-white border border-light border-opacity-25 px-3 py-2 fw-semibold"><i class="fa-solid fa-check text-warning me-1"></i> Organic Food Exporters</span><span class="badge bg-white bg-opacity-15 text-white border border-light border-opacity-25 px-3 py-2 fw-semibold"><i class="fa-solid fa-check text-warning me-1"></i> Handicraft &amp; Furniture Makers</span><span class="badge bg-white bg-opacity-15 text-white border border-light border-opacity-25 px-3 py-2 fw-semibold"><i class="fa-solid fa-check text-warning me-1"></i> Northern Retail Chains</span><span class="badge bg-white bg-opacity-15 text-white border border-light border-opacity-25 px-3 py-2 fw-semibold"><i class="fa-solid fa-check text-warning me-1"></i> Tour &amp; Excursion Agencies</span></div>
                    </div>
                </div>
                ...
                <div class="col-lg-5">
                    <div class="p-4 bg-white rounded-4 shadow-lg text-dark">
                        ...
                        <form action="send_mail.php" method="POST">
                            <input type="hidden" name="source" value="ERP Software in Chiang Mai &amp; Northern Thailand">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="th-card h-100">
                        ...
                        <h4>Hospitality &amp; Boutique Resort Operations</h4>
                        <p>Manage boutique hotel dining, spa reservations, housekeeping supplies, and guest billing with 7% VAT and service charge.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="th-card h-100">
                        ...
                        <h4>Organic Agriculture &amp; Fruit Processing</h4>
                        <p>Track northern organic farm harvests (coffee, tea, strawberries, longan), sorting grades, and packaging batch traceability.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="th-card h-100">
                        ...
                        <h4>Artisan Handicraft &amp; Furniture Manufacturing</h4>
                        <p>Manage production orders for wood carvings, ceramics, textiles, and custom home decor with material consumption tracking.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="th-card h-100">
                        ...
                        <h4>Northern Wholesale &amp; Retail Chain POS</h4>
                        <p>Operate fast barcode POS billing with PromptPay QR and real-time inventory sync across northern store branches.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="th-card h-100">
                        ...
                        <h4>Export Documentation &amp; Air Freight Billing</h4>
                        <p>Issue international commercial invoices and packing lists for global export shipments via Chiang Mai International Airport.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="th-card h-100">
                        ...
                        <h4>Thai Accounting &amp; Withholding Tax (50 Tawi)</h4>
                        <p>Maintain compliant financial books, expense vouchers, vendor withholding tax certificates, and monthly VAT ledgers.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="p-4 bg-light-th rounded-4 border">
                        ...
                        <h6 class="fw-bold text-dark mb-2">Can Chiang Mai coffee roasters and organic food producers manage farm-to-cup batch traceability with Digify?</h6>
                        <p class="text-muted small mb-0" style="line-height: 1.7;">Yes. Digify tracks coffee cherry source farms, roasting lot numbers, cupping scores, and packaging dates with complete traceability.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-5" style="background: linear-gradient(135deg, #091a2e 0%, #1e3a5f 100%); color: #ffffff;">
        <div class="container text-center py-4">
            <h2 class="fw-bold mb-3">Deploy ERP Software in Chiang Mai &amp; Northern Thailand</h2>
