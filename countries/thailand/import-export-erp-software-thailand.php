...
$pageTitle = "Import & Export ERP Software in Thailand | Customs, Port Clearance & Forex";
$pageDescription = "Comprehensive Import & Export ERP software in Thailand for international trading companies, customs brokers, container shipping, and BOI bonded operations.";
$pageKeywords = "Import & Export ERP Software in Thailand, Customs, Port Clearance & Forex, ERP software Thailand, Thailand VAT, e-Tax Invoice, BOI Thailand, Digify ERP";
$pageCanonical = "https://www.digifysoft.in/import-export-erp-software-thailand";
...
<div class="th-page-wrapper">
            ...
            <div class="row align-items-center">
                <div class="col-lg-7 mb-4 mb-lg-0">
                    <div class="th-hero-badge">
                        <span>🇹🇭 Global Trade &amp; Port Gateway</span>
                    </div>
                    <h1>Import &amp; Export ERP Software in Thailand</h1>
                    <div class="th-hero-sub">Customs Tariffs, Landed Costs, Container Tracking &amp; Foreign Currency Forex</div>
                    <p class="th-hero-desc">Master international supply chains operating through Laem Chabang Port, Bangkok Port (Klong Toey), and Suvarnabhumi Airport. Digify Import/Export ERP automates landed cost allocation, multi-currency accounting, commercial invoices, and customs paperwork.</p>
                ...
                <div class="col-lg-5">
                    <div class="p-4 bg-white rounded-4 shadow-lg text-dark">
                        ...
                        <form action="send_mail.php" method="POST">
                            <input type="hidden" name="source" value="Import &amp; Export ERP Software in Thailand">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="th-card h-100">
                        ...
                        <p>Apportion ocean freight, terminal handling charges (THC), Thai customs duties, customs broker fees, and local transport into item unit costs.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="th-card h-100">
                        ...
                        <p>Generate export documentation in USD, EUR, or JPY including commercial invoices, certificates of origin, and container packing declarations.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="th-card h-100">
                        ...
                        <p>Track currency fluctuations between purchase order booking, goods customs receipt date, and final foreign currency bank settlement.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="th-card h-100">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="th-card h-100">
                        ...
                        <h4>BOI &amp; Bonded Warehouse Privileges</h4>
                        <p>Maintain specialized inventory ledgers separating duty-paid domestic stock from duty-exempt raw materials destined for export.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="th-card h-100">
                        ...
                        <h4>Thai 7% VAT &amp; Zero-Rated Export Filings</h4>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="p-4 bg-light-th rounded-4 border">
                        ...
                        <h6 class="fw-bold text-dark mb-2">How does Digify allocate customs duties and ocean freight to imported SKU costs?</h6>
                        <p class="text-muted small mb-0" style="line-height: 1.7;">You can allocate landing expenses across shipment items based on weight, volume, or invoice value, giving you exact gross margin calculations for every product.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-5" style="background: linear-gradient(135deg, #091a2e 0%, #1e3a5f 100%); color: #ffffff;">
        <div class="container text-center py-4">
            <h2 class="fw-bold mb-3">Deploy Import &amp; Export ERP Software in Thailand</h2>
